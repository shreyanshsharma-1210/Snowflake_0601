 ...
 * This method should not be called directly, use the addBand action on the store instead
 */
 ...
 * This method should not be called directly, use the updateBand action on the store instead
 */
 ...
 * This method should not be called directly, use the removeBand action on the store instead
 */
